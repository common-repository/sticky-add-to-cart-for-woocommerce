...
class WC_Sticky_Add_To_Cart {
  ...
  */
  ...
  public function __construct() {
    ...
    // add_action( 'admin_menu',  array( $this,'remove_my_menu_page' ) );
  ...
  */
  public function wsac_enque_scripts() {
    ...
    if( $this->option('product_image_shape') == 'round' )
      $css .= ".mg-wsac-fix-sticky-bar img.mg-wsac-large { border-radius : 70% }";
    if( $this->option('product_image_shape') == 'round' )
      $css .= ".mg-wsac-fix-sticky-bar img.mg-wsac-small { border-radius : 40% }";

    // if( $this->option('thumbnail_size') == 'small' )
    //   $css .= ".mg-wsac-fix-sticky-bar img.mg-wsac-circle { border-radius : 30% }";
  ...
  public function get_sticky_add_to_cart_bar( $product_id  ) {
    ...
    $thumbnail_all_size_get = $this->option('thumbnail_size');
    ?>
    ...
    <div class="mg-wsac-fix-sticky-bar classic-sticky-cart <?php echo $class; ?>  mg-wsac-container">
      ...
      <div class="mg-wsac-row mg-wsac-wrap product-sticky-sec <?php echo $thumbnail_all_size_get == 'large' || $thumbnail_all_size_get == 'medium' ? '' : 'smallsize'; ?>">
        <!-- First section -->
        <div class="col-width mg-wsac-image-container mg-wsac-container right-border fst-cont-div">
          <div class="mg-wsac-row mg-height">
            ...
            if ( $thumbnail_all_size_get == 'medium' ) {
              ?>
              <div class="img-col-width mg-wsac-container  mg-wsac-center  padding">
                <div class="img center-blck-img" style=" ">
            ...
            if ( $thumbnail_all_size_get == 'small' ) {
              ?>
              <div class="img-col-width mg-wsac-container  mg-wsac-center  padding " >
                <div class="img center-blck-img" style=" ">
                  <?php $image = wp_get_attachment_image_src( get_post_thumbnail_id( $product_id ), 'single-post-thumbnail' );?>
                  <img src="<?php echo $image[0]?>" class="mg-wsac-small" alt="<?php echo $product->get_name(); ?>"  >
                </div>
              </div>
            <?php
        ...
        <div class="col-width mg-wsac-price-container mg-wsac-container right-border  mg-wsac-center "  >
          <div class="mg-wsac-row  mg-height" >
            <div class="mg-wsac-col mg-wsac-container mg-wsac-center center-blck padding">
              ...
              $currency_position = $this->option('currency_position');
                ...
                <span class="mg-wsac-badge">
                  <?php 
                      if( $currency_position == 'left' ) {
                        ...
                        echo $currency_symb.number_format( $product->get_sale_price() , 2 );

                      } else if ( $currency_position == 'right' ) {
                        
                        echo number_format( $product->get_sale_price() , 2 ) . ' ' . $currency_symb;
                  ...
                  <?php
                    if( $currency_position == 'left' ) {
                      ...
                      if( $product->get_regular_price() !== '' ) :
                        ...
                        echo number_format( $product->get_regular_price(), 2 ) . ' ' . $currency_symb;
                ...
                <?php
                  ...
                  if ( $product->get_type() === 'variable' ) {
                    ...
                    <?php
                        ...
                        if( $currency_position == 'right' ) {
                          ...
                          if ( $max_price !== '' ) {
                              ...
                              $product_price =  number_format( $max_price, 2 ) . ' ' . $currency_symb;

                          } else {

                              $product_price =  number_format( $min_price, 2 ) . ' ' . $currency_symb;
                    ...
                    <?php
                      ...
                      if ($product->get_regular_price() !== '') {
                          echo '<span class="mg-wsac-badge">' . $currency_symb . number_format($product->get_regular_price(), 2) . '</span>';
                      }
                  }
