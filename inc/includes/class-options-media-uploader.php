<?php
class Wsac_Options_Framework_Media_Uploader {
	...
	public function init() {
		add_action( 'admin_enqueue_scripts', array( $this, 'wsac_optionsframework_media_scripts' ) );
	}
	...
	static function wsac_optionsframework_uploader( $_id, $_value, $_desc = '', $_name = '' ) {
	 ...
	 */
	function wsac_optionsframework_media_scripts( $hook ) {

		$menu = Wsac_Options_Framework_Admin::menu_settings();
		...
		wp_register_script( 'of-media-uploader', WSAC_OPTIONS_FRAMEWORK_DIRECTORY .'assets/js/media-uploader.js', array( 'jquery' ), Wsac_Options_Framework::VERSION );
		wp_enqueue_script( 'of-media-uploader' );
		wp_localize_script( 'of-media-uploader', 'wsac_optionsframework_l10n', array(
