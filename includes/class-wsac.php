...
! defined( 'ABSPATH' ) AND exit; // No direct file access
  ...
  public function check_required_plugins() {
    ...
    if ( ! is_plugin_active( 'woocommerce/woocommerce.php' ) ) { ?>
      ...
      <?php deactivate_plugins( '/sticky-add-cart-for-woocommerce/woocommerce-sticky-add-cart.php' );
    }
  }
	...
	public function init() {
		...
		?>
			<!-- Main Container of stick bar -->
				<div class="mg-wsac-fix-sticky-bar <?php echo $class; ?>  mg-wsac-container">
					<!-- Main Row of sticky bar -->
					<div class="mg-wsac-row" >
						<!-- First section -->
						<div class="col-width  mg-wsac-container  right-border fst-cont-div">
							<div class="mg-wsac-row height">
								...
								<div class="img-col-width mg-wsac-container  mg-wsac-center  padding">
									<div class="img center-blck-img " style=" ">
										...
										?>
							    	<img src="<?php echo $image[0]?>" class="mg-wsac-circle" alt="" style="height: 100%" >
								  </div>
								</div>
								...
								<div class="name-col-width mg-wsac-container  padding" style="height: inherit; ">
									<div class="mg-wsac-row " style="height: inherit; position: relative;">
										<!-- Name Section -->
						...
						<div class="col-width mg-wsac-container right-border  mg-wsac-center "  >
							<div class="mg-wsac-row  height" >
						...
						<div class="col-width mg-wsac-container right-border  mg-wsac-center star-contr-div " >
							<div class="mg-wsac-row  height" >
								<!-- Star counting section -->								
								<div class="mg-wsac-col mg-wsac-container  mg-wsac-center center-blck-star "  style="width:100%">
									<span class="rateyo star-margin" data-star =" <?php echo $product_details->get_average_rating() ; ?>">
								  </span> 
								</div>
						...
						<div class="col-width mg-wsac-container mg-wsac-center padding"  >
							<div class="mg-wsac-row  height" >
								<div class="mg-wsac-col mg-wsac-container mg-wsac-center center-blck stky-cart-section">
									...
									?>
								    <a href="<?php echo $shop_page_url; ?>/shop/?add-to-cart=<?php echo $post->ID?>" class="mg-wsac-button <?php echo $product_class; ?>  mg-wsac-round-xxlarge mg-wsac-btn cart-text">

								    <?php if( $product_class == 'variable-product' ) : ?>
								    	<?php echo _e($options['variable_text'] , 'wsac'); ?></a>
								    <?php else : ?>
								    	<?php echo _e($options['text'] , 'wsac'); ?></a>
								    <?php endif; ?>
	...
	*/
	public function wsac_enque_scripts() {
		...
		$css .= ".mg-wsac-badge{border-radius : $badge_shape ; color : $options[text_color_badge] ; background : $options[badge_background] }";
