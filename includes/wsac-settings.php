	...
	public function get_settings() {
		...
		return apply_filters( 'woocommerce_' . $this->id . '_settings', array(
			...
			array( 'title' => __( 'Woocommerce Sticky Add To Cart', 'wsac' ), 'type' => 'title', 'desc' => '', 'id' => 'sticky_bar_title' ),
				...
				array(
					'title'   => __( 'Currency sign', 'wsac' ),
					'desc'    => __( 'Currency sign on single product pages', 'wsac' ),
					'type'    => 'checkbox',
					'id'    	=> 'wsac[currency_sign]',
					'default' => 'no'
				),
				...
				array(
					'title'   => __( 'Size of the Thumbnail', 'wsac' ),
					'desc'    => __( 'Size of the thumbnail on single product pages', 'wsac' ),
					'type'    => 'text',
					'id'    	=> 'wsac[thumbnail_size]',
					'default' => 'no'
				),
				array(
